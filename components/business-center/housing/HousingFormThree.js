				...
				>
					<div>
						...
						<div
							className={`${
								priceOption === "exact"
									? " transition-opacity duration-300 h-auto opacity-100 flex gap-4 pl-4 w-full"
									: " h-0 opacity-0"
							}`}
						>
					...
					<div>
						...
						<div
							className={`${
								priceOption === "range"
									? " transition-opacity duration-300 h-auto opacity-100 flex items-center gap-4 pl-4 w-full"
									: " h-0 opacity-0"
							}`}
						>
							<div className="relative flex-grow">
							...
							<div>
								<select
									...
									onChange={handleChangePrice}
									className="rounded bg-[color:var(--input-bg-secondary)] text-[color:var(--deals-primary)] w-fit p-2 h-full "
								>
									<option value="day">Day</option>
									<option value="week">Week</option>
									<option value="month">Month</option>
